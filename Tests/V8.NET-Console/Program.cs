        ...
        static void Main(string[] args)
        {
            ...
            try
            {
...

                {
                    ...
                    _JSServer.GlobalObject.SetProperty(typeof(SealedObject), V8PropertyAttributes.Locked, null, true, null);
...
";
                            _JSServer.GlobalObject.SetProperty(typeof(SomeMethods), V8PropertyAttributes.None, null, true, ScriptMemberSecurity.ReadWrite);
                            var sm = new SomeMethods();
                            _JSServer.GlobalObject.SetProperty("shared", sm, null, true, null);
