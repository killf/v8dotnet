namespace V8.Net
{
    ...
    {
        private readonly ReaderWriterLock m_rwLock;
    ...
    public struct WriterLock : IDisposable
    {
        ...
        {
            m_rwLock = rwlock;
            m_rwLock.AcquireWriterLock(timeout);
        }
    ...
    public static class ExtensionMethods
    {
        ...
        public static ReaderLock ReadLock(this ReaderWriterLock _this)
        {
            return ReadLock(_this, Int32.MaxValue);
        }
        ...
        public static WriterLock WriteLock(this ReaderWriterLock _this)
        {
            return WriteLock(_this, Int32.MaxValue);
        }
    ...
    public static unsafe class Utilities
    {
        ...
        public static HandleProxy** MakeHandleProxyArray(InternalHandle[] items)
        {
            ...
            var nativeArrayMem = (HandleProxy**)AllocPointerArray(items.Length);

            for (var i = 0; i < items.Length; i++)
                nativeArrayMem[i] = items[i];
        ...
        public static Int16 ND(object val, Int16 defaultVal)
        { return (val == DBNull.Value || val == null) ? (defaultVal) : (ToInt16(val, defaultVal) ?? defaultVal); }
        public static Int32 ND(object val, Int32 defaultVal)
        { return (val == DBNull.Value || val == null) ? (defaultVal) : (ToInt32(val, defaultVal) ?? defaultVal); }
        public static Int64 ND(object val, Int64 defaultVal)
        { return (val == DBNull.Value || val == null) ? (defaultVal) : (ToInt64(val, defaultVal) ?? defaultVal); }
        public static float ND(object val, float defaultVal)
        { return (val == DBNull.Value || val == null) ? (defaultVal) : (ToSingle(val, defaultVal) ?? defaultVal); }
        public static decimal ND(object val, decimal defaultVal)
        { return (val == DBNull.Value || val == null) ? (defaultVal) : (ToDecimal(val, defaultVal) ?? defaultVal); }
        public static bool ND(object val, bool defaultVal)
        { return (val == DBNull.Value || val == null) ? (defaultVal) : (ToBoolean(val, defaultVal) ?? defaultVal); }
        public static double ND(object val, double defaultVal)
        { return (val == DBNull.Value || val == null) ? (defaultVal) : (ToDouble(val, defaultVal) ?? defaultVal); }
        public static DateTime ND(object val, DateTime defaultVal)
        { return (val == DBNull.Value || val == null) ? (defaultVal) : (ToDateTime(val, defaultVal) ?? defaultVal); }

        // ... more of the same, but using nullable parameters ...
        public static bool ND(object val, bool? defaultVal) { return ND(val, defaultVal ?? false); }
        public static double ND(object val, double? defaultVal) { return ND(val, defaultVal ?? 0d); }
        public static decimal ND(object val, decimal? defaultVal) { return ND(val, defaultVal ?? 0m); }
        public static float ND(object val, float? defaultVal) { return ND(val, defaultVal ?? 0f); }
        public static Int16 ND(object val, Int16? defaultVal) { return ND(val, defaultVal ?? 0); }
        public static Int32 ND(object val, Int32? defaultVal) { return ND(val, defaultVal ?? 0); }
        public static Int64 ND(object val, Int64? defaultVal) { return ND(val, defaultVal ?? 0); }
        public static DateTime ND(object val, DateTime? defaultVal) { return ND(val, defaultVal ?? DateTime.MinValue); }
    ...
    public static class Strings
    {
        ...
        {
            var strings = new string[sa1.Length + sa2.Length];
        ...
        /// <param name="suffixIfPlural">Suffix to use if "value" is not 1.</param>
        /// <param name="numberFormatting">The number format, if any (optional).</param>
        public static string S(int value, string word, string suffixIfPlural, string numberFormatting)
        {
            if (value != 1) return (numberFormatting != null ? FormatNumber(value, numberFormatting) : value.ToString()) + " " + word + suffixIfPlural;
            return value + " " + word;
        }

        public static string S(int value, string word, string suffixIfPlural)
        {
            return S(value, word, suffixIfPlural, null);
        }
        ...
        {
            if (value != 1) return (numberFormatting != null ? FormatNumber(value, numberFormatting) : value.ToString(CultureInfo.CurrentCulture)) + " " + word + suffix_if_plural;
            return value + " " + word;
        }
    ...
    public static class Arrays
    {
        ...
        public static T[] Convert<T>(IList array)
        {
            ...
            for (int i = 0; i < array.Count; i++)
                convertedItems[i] = (T)System.Convert.ChangeType(array[i], typeof(T), Thread.CurrentThread.CurrentCulture);
        ...
        public static T[] ConvertWithDefaults<T>(IList array)
        {
            ...
            for (int i = 0; i < array.Count; i++)
            {
                try { convertedItems[i] = (T)System.Convert.ChangeType(array[i], typeof(T), Thread.CurrentThread.CurrentCulture); }
