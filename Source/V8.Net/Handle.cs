namespace V8.Net
{
    ...
    public unsafe class Handle : IHandle, IHandleBased, IDynamicMetaObjectProvider, IBasicHandle, IFinalizable
    {
        ...
        public Handle Clone()
        {
            if (HandleInternal.IsObjectType)
                return new ObjectHandle(HandleInternal);
            else
                return new Handle(HandleInternal);
        }
        ...
        /// </summary>
        public virtual V8Engine Engine
        {
            get
            {
                return HandleInternal.Engine;
            }
        }
        ...
        /// </summary>
        public int Id { get { return HandleInternal.Id; } }
        ...
        public override string ToString() { return HandleInternal.ToString(CultureInfo.CurrentCulture); }
    ...
    public interface IV8Object
    {
        ...
        bool SetProperty(string name, InternalHandle value);
        ...
        bool SetProperty(string name, object obj);
    ...
    public unsafe class ObjectHandle : Handle, IV8Object
    {
        ...
        {
            return handleProxy != null ? new ObjectHandle(handleProxy) : Empty;
        }
        ...
        {
            get { return HandleInternal.Prototype; }
        }
    ...
    {
        private readonly IV8Object m_handle;
        private readonly V8Engine m_engine;
            ...
            : base(parameter, BindingRestrictions.Empty, value)
        {
            ...
            var handleBased = value as IHandleBased;
            if (handleBased != null)
                m_engine = handleBased.Engine;
        }
#else
        ...
        public override DynamicMetaObject BindGetMember(GetMemberBinder binder)
        {
            if (m_handle == null) throw new InvalidOperationException(NotAnObjectErrorMessage);
        ...
        public override DynamicMetaObject BindSetMember(SetMemberBinder binder, DynamicMetaObject value)
        {
            ...
            if (isHandle || isV8NativeObject)
            {
                Func<object, InternalHandle> handleParamConversion
                    = obj => (obj is IHandleBased) ? ((IHandleBased)obj).AsInternalHandle
                        : m_engine != null ? m_engine.CreateValue(obj)
            ...
            var restrictions = Restrictions.Merge(value.Restrictions);
        ...
        public override DynamicMetaObject BindConvert(ConvertBinder binder)
        {
            ...
            Restrictions.Merge(BindingRestrictions.GetTypeRestriction(convertExpression, binder.Type));
